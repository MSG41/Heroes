...
export default function HeroesPage({ heroes, heroSkills }) {
  ...
  return (
    <div className="w-[100%] mt-[-100px]">
      <div className=" xl:sticky xl:left-[4vw] xl:top-[0.09%] xl:mt-[12vh] md:mt-10 xl:mb-[-14vh]  text-sm text-white italic xs:sticky xs:mt-[10vh] xs:left-[63%] md:left-[80%] md:top-5 xs:pl-4 xs:pr-4 xs:text-[170%] xs:pt-3 xs:pb-3  xl:text-sm xs:sticky xs:top-[2.7em] xs:z-[999] xs:bg-gradient-to-r from-indigo-500/60 via-emerald-500/90 to-yellow-500/90 hover:from-pink-500 xs:hover:to-yellow-500 xs:rounded-full xs:w-fit">
        {heroesFoundMessage}
      </div>
