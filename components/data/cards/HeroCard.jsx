...
const HeroCard = ({ hero }) => {
  ...
  return (
    <div
      ...
      className={` shadow-lg  md:w-[100%] xl:w-[100%] rounded-sm border px-5 py-4 flex justify-start hover:border-slate-300 transition duration-300 ease-out hover:ease-in ${
        hero.featuredHero
